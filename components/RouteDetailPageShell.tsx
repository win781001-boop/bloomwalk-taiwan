/* Shared route detail page shell for skeleton counties */
...
export default function RouteDetailPageShell({
  route,
  routes,
  countySlug,
  countyName,
        ...
        <section className={
          ...
          <div className="mx-auto max-w-3xl">
            <nav className="mb-6 text-xs text-bloom-text-light/60">
              ...
              <a href={`/${countySlug}`} className="hover:text-bloom-green">{countyName}</a>
              <span className="mx-2">/</span>
            ...
            <div className="mt-6 grid gap-4 rounded-xl border border-bloom-green-light/40 bg-white/70 p-5 sm:grid-cols-2">
              <div>
                ...
                <p className="mt-1 text-xs font-medium text-bloom-gold">
                  {route.postcardAppeal}/5 — {route.postcardAppeal >= 5 ? `${countyName}代表地標，值得特地收集` : route.postcardAppeal >= 4 ? "有特色，適合順路安排" : "實用散步點，明信片吸引力普通"}
                </p>
