...
/** ??????????? (A-H ??) */
/** 高雄澄清湖路線景點資料 (A-H 點位) */
export const kaohsiungChengcingLakeSpots: Spot[] = [
  {
    id: "chengcing-A",
    name: "海洋奇珍園",
    city: "高雄",
...
/** 高雄西子灣路線景點資料 (A-H 點位) */
export const kaohsiungSizihwanSpots: Spot[] = [
  {
    id: "sizihwan-A",
    name: "鼓山輪渡站",
    city: "高雄",
  ...
  },
  {
    ...
    city: "高雄",
    district: "鼓山區",
    typeTags: ["歷史建築", "文化園區", "古蹟"],
    useTags: ["明信片收集", "文化學習", "拍照"],
    tags: ["postcard", "walk", "heritage"],
...
/** 高雄橋頭糖廠路線景點資料 (A-H 點位) */
export const kaohsiungQiaotouSugarRefinerySpots: Spot[] = [
  {
    id: "qiaotou-A",
    name: "橋頭老街",
    city: "高雄",
