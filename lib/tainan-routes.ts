...
export const tainanRoutes: TainanRoute[] = [
  ...
  {
    slug: "tainan-confucius-temple",
    primaryCategory: "heritage",
    name: "孔廟・文學館・美術館文化路線",
    area: "臺南 / 中西區",
    summary: "孔廟、文學館、美術館、司法博物館、文化散步",
    postcardAppeal: 5,
    postcardReason: "臺南孔廟、臺灣文學館與司法博物館是府城文化核心地標，歷史建築群畫面辨識度高。",
    walkingComfort: 4,
    transportConvenience: 5,
    duration: "約 90～150 分鐘",
    bestTime: "早上 / 下午",
    transport: "臺南火車站步行約 10 分鐘，或搭 1 路公車至孔廟站",
    tags: ["古蹟", "文化", "博物館", "歷史", "街區"],
    icon: "📚",
    whyVisit: "孔廟、臺灣文學館、臺南市美術館與司法博物館集中在市中心區域，步行可串聯成一條文化散步路線。歷史建築群與現代藝文空間交錯，適合想收集臺南文化景點明信片的玩家。",
    routeSteps: ["從臺灣文學館出發", "步行至臺南市美術館與孔廟", "延伸至愛國婦人館與司法博物館", "最後沿南門路走訪假日花市與南門公園"],
    pikminReasons: ["府城文化核心地標密度高", "歷史建築適合明信片收集", "市中心步行可串聯", "交通方便、補給充足"],
    tips: ["美術館週一休館，請留意開放時間", "孔廟與文學館假日遊客較多", "可與赤崁樓路線串聯安排半日散步"],
    supplies: ["孔廟周邊", "南門路商圈", "便利商店", "公共廁所", "孔廟與文學館休憩空間"],
    nearbyRoutes: ["chihkan-old-town"],
    mapUrl: "https://www.google.com/maps/search/孔廟+臺南",
  },
  {
    slug: "yuguang-island",
    primaryCategory: "coast",
    name: "漁光島・德陽艦・億載金城海景路線",
    area: "臺南 / 安平區",
    summary: "海景、軍艦、砲臺、沙灘、夕陽",
    postcardAppeal: 5,
    postcardReason: "漁光島沙灘夕陽、德陽艦園區與億載金城各有不同海景與歷史畫面，適合收集安平港區明信片。",
    walkingComfort: 4,
    transportConvenience: 3,
    duration: "約 90～150 分鐘",
    bestTime: "午後 / 傍晚",
    transport: "臺南火車站前搭 2 路公車至濱海站，或騎車／開車至安平港區",
    tags: ["海景", "沙灘", "古蹟", "夕陽", "軍事"],
    icon: "🏖️",
    whyVisit: "漁光島、德陽艦園區、億載金城與林默娘公園集中在安平港南側，從海景沙灘到軍事遺產，景觀變化豐富。適合想收集安平港區多樣畫面明信片的玩家。",
    routeSteps: ["從林默娘公園出發", "走訪定情碼頭德陽艦園區", "延伸至億載金城與虱目魚主題館", "最後前往漁光島沙灘與巨人耳機防波堤看夕陽"],
    pikminReasons: ["海景與軍事遺址畫面變化豐富", "漁光島沙灘夕陽辨識度高", "適合午後散步", "沿線景點集中在安平港區"],
    tips: ["漁光島沙灘傍晚夕陽最佳", "德陽艦園區有入館費用", "夏天海邊日曬強，注意防曬與補水", "可與安平古堡路線串聯安排一日散步"],
    supplies: ["安平港區周邊", "德陽艦園區", "便利商店", "公共廁所", "漁光島沙灘周邊"],
    nearbyRoutes: ["anping-old-fort"],
    mapUrl: "https://www.google.com/maps/search/漁光島+臺南",
  },
];
