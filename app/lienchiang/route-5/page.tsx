...
export default function Page() {
  ...
  return (
    ...
    >
      <連江縣RouteDetailPage route={route} hideHeader />
    </GenericRouteMapPageTemplate>
  );
}