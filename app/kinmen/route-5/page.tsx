...
export default function Page() {
  ...
  return (
    ...
    >
      <金門縣RouteDetailPage route={route} hideHeader />
    </GenericRouteMapPageTemplate>
  );
}