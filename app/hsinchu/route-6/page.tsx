...
import { getHsinchuRouteBySlug } from "@/lib/hsinchu-routes";
import GenericRouteMapPageTemplate from "@/components/GenericRouteMapPageTemplate";
import 新竹縣RouteDetailPage from "../RouteDetailPage";
...
export default function Page() {
  const route = getHsinchuRouteBySlug("route-6");
  ...
  return (
    ...
    >
      <新竹縣RouteDetailPage route={route} hideHeader />
    </GenericRouteMapPageTemplate>
  );
}