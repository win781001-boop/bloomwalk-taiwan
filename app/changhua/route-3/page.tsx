...
import { getChanghuaRouteBySlug } from "@/lib/changhua-routes";
import GenericRouteMapPageTemplate from "@/components/GenericRouteMapPageTemplate";
import 彰化縣RouteDetailPage from "../RouteDetailPage";
...
export default function Page() {
  const route = getChanghuaRouteBySlug("route-3");
  ...
  return (
    ...
    >
      <彰化縣RouteDetailPage route={route} hideHeader />
    </GenericRouteMapPageTemplate>
  );
}