...
import { getYilanRouteBySlug } from "@/lib/yilan-routes";
import GenericRouteMapPageTemplate from "@/components/GenericRouteMapPageTemplate";
import YilanRouteDetailPage from "../RouteDetailPage";
...
export default function Page() {
  const route = getYilanRouteBySlug("route-6");
  ...
  return (
    ...
    >
      <YilanRouteDetailPage route={route} hideHeader />
    </GenericRouteMapPageTemplate>
  );
}