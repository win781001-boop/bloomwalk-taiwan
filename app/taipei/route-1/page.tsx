...
export default function Page() {
  ...
  return (
    ...
    >
      <臺北市RouteDetailPage route={route} hideHeader />
    </GenericRouteMapPageTemplate>
  );
}