...
import { getHsinchuCityRouteBySlug } from "@/lib/hsinchu-city-routes";
import GenericRouteMapPageTemplate from "@/components/GenericRouteMapPageTemplate";
import 新竹市RouteDetailPage from "../RouteDetailPage";
import { SpotCards } from "./SpotCards";

export const metadata: Metadata = { title: "待命名路線一 | Bloom Walk Taiwan", description: "待補充", robots: { index: false } };

export default function Page() {
  const route = getHsinchuCityRouteBySlug("route-1");
  ...
  return (
    ...
    >
      <新竹市RouteDetailPage route={route} hideHeader />
    </GenericRouteMapPageTemplate>
  );
}