...
const placeholderSpots: Spot[] = [
  { id: "A", name: "待補充", type: "—", desc: "景點資料準備中" },
  { id: "B", name: "待補充", type: "—", desc: "景點資料準備中" },
  { id: "C", name: "待補充", type: "—", desc: "景點資料準備中" },
  { id: "D", name: "待補充", type: "—", desc: "景點資料準備中" },
  { id: "E", name: "待補充", type: "—", desc: "景點資料準備中" },
  { id: "F", name: "待補充", type: "—", desc: "景點資料準備中" },
  { id: "G", name: "待補充", type: "—", desc: "景點資料準備中" },
  { id: "H", name: "待補充", type: "—", desc: "景點資料準備中" },
];
...
export function SpotCards({ spots = placeholderSpots }: { spots?: Spot[] }) {
  return (
    <section className="rounded-3xl bg-white p-4 shadow-xl">
      <h2 className="mb-4 text-lg font-bold text-slate-800">哈瑪星鐵道文化園區景點卡</h2>
