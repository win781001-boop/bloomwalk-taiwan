...
import { getHualienRouteBySlug } from "@/lib/hualien-routes";
import GenericRouteMapPageTemplate from "@/components/GenericRouteMapPageTemplate";
import HualienRouteDetailPage from "../RouteDetailPage";
...
export default function Page() {
  const route = getHualienRouteBySlug("route-5");
  ...
  return (
    ...
    >
      <HualienRouteDetailPage route={route} hideHeader />
    </GenericRouteMapPageTemplate>
  );
}