...
import { getNantouRouteBySlug } from "@/lib/nantou-routes";
import GenericRouteMapPageTemplate from "@/components/GenericRouteMapPageTemplate";
import 南投縣RouteDetailPage from "../RouteDetailPage";
...
export default function Page() {
  const route = getNantouRouteBySlug("route-5");
  ...
  return (
    ...
    >
      <南投縣RouteDetailPage route={route} hideHeader />
    </GenericRouteMapPageTemplate>
  );
}