...
import { getYunlinRouteBySlug } from "@/lib/yunlin-routes";
import GenericRouteMapPageTemplate from "@/components/GenericRouteMapPageTemplate";
import 雲林縣RouteDetailPage from "../RouteDetailPage";
...
export default function Page() {
  const route = getYunlinRouteBySlug("route-5");
  ...
  return (
    ...
    >
      <雲林縣RouteDetailPage route={route} hideHeader />
    </GenericRouteMapPageTemplate>
  );
}