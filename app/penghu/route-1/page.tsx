...
export default function Page() {
  ...
  return (
    ...
    >
      <澎湖縣RouteDetailPage route={route} hideHeader />
    </GenericRouteMapPageTemplate>
  );
}