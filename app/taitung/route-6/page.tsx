...
import { getTaitungRouteBySlug } from "@/lib/taitung-routes";
import GenericRouteMapPageTemplate from "@/components/GenericRouteMapPageTemplate";
import TaitungRouteDetailPage from "../RouteDetailPage";
...
export default function Page() {
  const route = getTaitungRouteBySlug("route-6");
  ...
  return (
    ...
    >
      <TaitungRouteDetailPage route={route} hideHeader />
    </GenericRouteMapPageTemplate>
  );
}