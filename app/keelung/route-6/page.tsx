...
export default function Page() {
  ...
  return (
    ...
    >
      <基隆市RouteDetailPage route={route} hideHeader />
    </GenericRouteMapPageTemplate>
  );
}